...
public class DialogComponent : MonoBehaviour
{
    ...
    public QQTextAsset messageAsset;
    ...
    public void Start()
    {
        ...
        serialPtr = 0;
#endif
        SetNameText(messageAsset.messageDataList[serialPtr].name);
        MessageRuning();
    }
    ...
    {
        QQTextData serialData = messageAsset.messageDataList[Serial];
