...
public static class TimelineCreaterExtension
{
    ...
    public static void CameraFocusRole(string spineName, TimelineAsset timelineAsset, BaseTextData messageData)
    {
    ...
    public static void EmptyTrack(string spineName, TimelineAsset timelineAsset, BaseTextData messageData)
    {
        if (string.IsNullOrEmpty(spineName)) return;
    ...
    public static void RoleDialogue(string spineName, TimelineAsset timelineAsset, BaseTextData messageData)
    {
        //提取出对话  
